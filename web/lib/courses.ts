...
export const COURSES: Record<string, Course> = {
 ...
 "modules": [
  ...
  {
   "id": "m8",
   "title": "Module 8 \u2014 The DM money machine",
   "goal": "Turn comments into an email list and a product that sells daily \u2014 the #1 theme-page monetization in 2026.",
   "steps": [
    {
     "key": "ig-m8-1",
     "title": "Set up comment-to-DM automation",
     "minutes": 30,
     "lesson": [
      "The mechanic: your video ends with 'comment TOOLKIT and I'll DM you the full list'. An automation replies to every such comment by DM with your link. Comments explode (algorithm boost) AND every commenter becomes a lead.",
      "Tool: ManyChat free tier (manychat.com) \u2014 connect your IG Creator account, create an automation: Trigger = comment contains your keyword -> Action = send DM with your link-in-bio page or lead magnet link.",
      "Rules that keep you safe: only trigger on YOUR chosen keyword, DM must deliver exactly what the video promised, never DM people who didn't comment, and reply speed set to 'immediately'.",
      "Use ONE keyword per video (TOOLKIT, PROMPTS, GUIDE...) so you can measure which video drives leads. Rotate keywords, keep the promise real."
     ],
     "verify": {
      "type": "screenshot",
      "prompt": "Screenshot of your ManyChat automation: trigger keyword + the DM message it sends."
     }
    },
    {
     "key": "ig-m8-2",
     "title": "Build the lead magnet that earns the DM",
     "minutes": 40,
     "lesson": [
      "A lead magnet is a genuinely useful free thing exchanged for attention: '25 AI prompts that save an hour a day' (PDF), 'The 10 free AI tools stack' (Notion page), or a 3-email mini-course.",
      "Make it in one sitting: ask Claude to draft it from your niche angle, format in Canva or Notion, export. Quality bar: would YOU save it? If not, redo.",
      "Delivery chain: comment -> DM -> link to a simple page (your link-in-bio tool or Beacons/Stan free tier) -> email required to download -> magnet delivered. The email step builds the asset nobody can take from you: the list.",
      "Disclosure stays on: if the magnet links affiliate tools, the 'links may earn us a commission' line goes on the page."
     ],
     "verify": {
      "type": "link",
      "prompt": "Link to your live lead-magnet page (the one your DM sends)."
     }
    },
    {
     "key": "ig-m8-3",
     "title": "Ship the $27 product",
     "minutes": 60,
     "lesson": [
      "The pattern that sells on theme pages: a compact, outcome-named digital product at $17-47. Examples for an AI niche: 'The AI Workday System' (template pack + guide), '100 prompts that replace a $500/mo stack', a Notion OS.",
      "Build v1 in a weekend, not a month: your best 20% of content, organized, with a quick-start. Sell via Gumroad or Lemon Squeezy (both handle VAT/merchant-of-record \u2014 works from UAE/TR without Stripe).",
      "Price at $27 launch. Your funnel: video -> comment keyword -> DM -> free magnet -> email -> 3-email sequence where email 3 offers the product. Sell to the LIST, not the feed.",
      "Never promise income outcomes from the product. Sell time saved, organization, capability \u2014 deliverables you control."
     ],
     "verify": {
      "type": "link",
      "prompt": "Your live product page link (Gumroad/Lemon Squeezy)."
     }
    }
   ]
  },
  {
   "id": "m9",
   "title": "Module 9 \u2014 Views money: the YouTube ladder",
   "goal": "The only reliable get-paid-for-views path \u2014 and how your Shorts feed it.",
   "steps": [
    {
     "key": "ig-m9-1",
     "title": "Understand where views actually pay",
     "minutes": 15,
     "lesson": [
      "Reality check, 2026: Instagram pays ~nothing per view (bonuses are invite-only). TikTok Creator Rewards pays $0.40-1.20 per 1k qualified views BUT only videos over 60s, only 10k+ follower accounts, and only in ~10 countries (not the Middle East yet). YouTube pays everyone in YPP: Shorts ~$0.01-0.07 per 1k (pooled), long-form $2-15 per 1k \u2014 AI/business niches at the top of that range.",
      "Translation: 1M views = ~$50 on Shorts vs $2,000-15,000 on 8-minute videos. The 'money from views' business IS YouTube long-form. Everything else is top-of-funnel.",
      "Your ladder: the same Shorts your Studio makes post to YouTube daily -> channel gains subs -> at 500 subs +3M Shorts views/90d you unlock fan funding; at 1,000 subs + 10M Shorts views/90d (or 4,000 long-form watch hours) you unlock full ad revenue.",
      "Survival rule: YouTube's 'inauthentic content' policy demonetizes mass-produced AI spam. Your defense is exactly what the Studio enforces \u2014 original scripts, your approval on every clip, real editorial choices. Never post unreviewed output."
     ],
     "verify": {
      "type": "text",
      "prompt": "In two lines: which platform pays meaningfully per view, and what are the TWO thresholds for full YouTube ad revenue?"
     }
    },
    {
     "key": "ig-m9-2",
     "title": "Start the long-form muscle",
     "minutes": 45,
     "lesson": [
      "Formula that works faceless in AI niches: 6-10 minute listicle/tutorial ('I tested 7 AI tools so you don't have to'), AI voiceover you review, screen recordings + your Studio visuals, chapters in description.",
      "Cadence: 1 long-form per week next to daily Shorts. The Shorts are discovery; the long-form is where watch hours and RPM live. Each Short's topic that overperforms becomes a long-form candidate \u2014 your performance data picks the topics.",
      "Structure every long-form: hook (first 20s states the payoff), chaptered segments, mid-video re-hook, end screen pointing at the next video. Retention is the algorithm's only love language.",
      "Publish target: 4 long-forms in your first month. Watch hours compound; this is the slowest and most durable asset in the whole system."
     ],
     "verify": {
      "type": "link",
      "prompt": "Link to your first published long-form YouTube video."
     }
    }
   ]
  }
