...
-- ======================================================
-- STEP 7: Settings defaults (kill switch, budget, model, schema version)
-- ======================================================
...
-- Clear any auto-rejects that happened while paused (bug fix from your complaint #1)
update public.board_items set status='idea'
 where status='rejected'
   and (payload->>'_auto_rejected_while_paused')::boolean is true;
